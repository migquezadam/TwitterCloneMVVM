...
//  TwitterClone
//
//  Created by Miguel Quezada on 23-10-22.
//
...
class TweetTableViewCell: UITableViewCell {
    ...
    private let tweetTextContentLabel: UILabel = {
        let label = UILabel()
        label.translatesAutoresizingMaskIntoConstraints = false
        label.text = "this is my mock up tweet is going to take multiple liones blablablablablablalbalbalbalbablablalbablbalbalblablablalbalbablablabalblablablablablalbablalbalbablablabllbablalbalbablablalbabl"
